...
-- The owner account should be created by the
-- backend setup process with a securely hashed
-- password.
--
-- Do NOT put the owner's password in this file.